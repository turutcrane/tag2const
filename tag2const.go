...
func main() {
	...
	if *prologue {
		g.Printf("// Code generated by tag2const; DO NOT EDIT.\n")
		g.Printf("\n")
		g.Printf("package %s", pkg.Name)
		g.Printf("\n")
		g.Printf("\n")
	}
	g.Printf("// \"tag2const %s\"\n", strings.Join(os.Args[1:], " "))
	g.generate(pkg)
